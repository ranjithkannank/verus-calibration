// Module `counter` for the counter_multifile exercise.
//
// The spec below is FROZEN as part of `spec-frozen-counter_multifile`.
// The implementer fills in the three exec method bodies; the closed
// spec functions and requires/ensures clauses must not be touched.
