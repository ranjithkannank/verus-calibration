// Witness for sensor_poll_signed/fusion.rs.
//
// Byte-equivalent to `exercises/sensor_poll_witness/fusion.rs` — the
// fusion module is unchanged across the two exercises. The witness
// is repeated here so check-spec.sh runs against a self-contained
// directory.
